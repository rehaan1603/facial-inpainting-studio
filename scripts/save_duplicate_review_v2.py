...
def main():
    ...
    # Reviewed ranked/active sheets and all pending_1..19 sheets.
    near={0,1,9,2,4,42,8,10,6,348,11,494}
    reviewed=set(range(len(pairs)))
    ...
    for index in sorted(reviewed):
        ...
        if index==494:decision='near_duplicate_scene_sequence'
    ...
    for dataset in ['celebahq','lapa']:
        ...
        dest=ROOT/'data/manifests'/f'{dataset}_reviewed_v2.csv'
    ...
    (ROOT/'research/near_duplicate_review_v2.json').write_text(json.dumps(review,indent=2))
