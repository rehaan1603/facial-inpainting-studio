...
def main():
    import diffusers
    base=ROOT/'outputs/regional_routing_v1';base.mkdir(exist_ok=True)
    protocol_path=ROOT/'research/protocols/regional_routing_protocol_v1.json';cfg=json.loads(protocol_path.read_text())
